...
export const InlineToolbar = () => {
  ...
  const [open, setOpen, disabled, theme] = useInlineToolbarOpen(editor)
  ...
  const handleOpen = React.useCallback(
    ...
    [editor, setOpen, updatePoint, disabled],
  )
  ...
  React.useEffect(() => {
    ...
    document.addEventListener('scroll-erp-editor', onScroll)
    return () => {
      document.removeEventListener('scroll-erp-editor', onScroll)
    }
  }, [open])
  return (
    <Popover
